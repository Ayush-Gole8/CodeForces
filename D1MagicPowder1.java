...
public class D1MagicPowder1 {
    ...
    static int msb(long x)       { return 63 - Long.numberOfLeadingZeros(x); }
    ...
    static void solve(){
        ...
        java.util.function.LongPredicate f=(x)->{
            long p=0;
            for(int i=0;i<n;i++){
                long r=x*a[i];
                if(r>b[i]){
        ...
        long ans=binarySearchLast(0,2000000005L,f);
        println(ans);
    }
    ...
    public static void main(String[] args) {
        int t = 1; // Explicitly set to 1 for this problem
        while (t-- > 0) solve();
        out.flush();
    }
